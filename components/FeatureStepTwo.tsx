    ...
    <div className="relative min-h-0 md:min-h-[70vh] py-10 sm:py-14 md:py-20 flex items-center overflow-hidden bg-[#b4c9b1]">
      <div className="container mx-auto px-4 sm:px-6 relative z-10 w-full">
        <div className="grid md:grid-cols-[0.85fr_1.15fr] gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
          ...
          <div className="flex justify-center md:justify-end items-center min-h-[240px] sm:min-h-[320px] md:min-h-[450px] lg:min-h-[520px] w-full min-w-0">
            <img
              src="/images/step2.gif"
              alt="Interface Ride'n'Rest - visualisation des hébergements sur la trace"
              className="max-w-full w-full md:w-auto md:max-w-[min(100%,640px)] h-auto max-h-[45vh] sm:max-h-[55vh] md:max-h-[70vh] lg:max-h-[80vh] rounded-xl sm:rounded-2xl sm:shadow-2xl sm:border sm:border-white/20 object-contain"
            />
          </div>
        </div>
      </div>
